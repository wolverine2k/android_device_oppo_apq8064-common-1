...
$(INSTALLED_RECOVERYIMAGE_TARGET): $(MKBOOTIMG) \
	...
	$(hide) rm -rf $(TARGET_RECOVERY_ROOT_OUT)/sbin/static $(TARGET_RECOVERY_ROOT_OUT)/sbin/charger_oppo $(TARGET_RECOVERY_ROOT_OUT)/res/images/charger $(TARGET_RECOVERY_ROOT_OUT)/lvm* $(TARGET_RECOVERY_ROOT_OUT)/init.fs*
